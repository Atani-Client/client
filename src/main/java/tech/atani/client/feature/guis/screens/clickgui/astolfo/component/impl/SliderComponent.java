...
public class SliderComponent extends ValueComponent {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        normal.drawString(((Number)value.getValue()).floatValue() + "", getPosX() + this.getBaseWidth() - 5 - normal.getStringWidth(((Number)value.getValue()).floatValue() + "") + getAddX(), getPosY() + getBaseHeight() / 2 - normal.FONT_HEIGHT / 2, -1);
        if(this.expanded) {
            ...
            normal.drawString(max, getPosX() + this.getBaseWidth() - 5 - normal.getStringWidth(max) + getAddX(), getPosY() + getBaseHeight() + getBaseHeight() / 2 - normal.FONT_HEIGHT / 2, -1);
