    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if(expanded) {
            ...
            for(String string : multiStringBoxValue.getValues()) {
                ...
                normal.drawStringWithShadow("X", getPosX() + this.getBaseWidth() - 5 - normal.getStringWidth("X") + getAddX(), getPosY() + getBaseHeight() / 2 - normal.FONT_HEIGHT / 2, !multiStringBoxValue.get(string) ? new Color(200, 200, 200).getRGB() : -1);
