...
@Native
@ModuleData(name = "TpAura", description = "Attacks people", category = Category.COMBAT, key = Keyboard.KEY_R)
public class TpAura extends Module {

    public SliderValue<Float> findRange = new SliderValue<>("Search Range", "What'll be the range for searching for targets?", this, 150f, 3f, 300f, 1);
    ...
    public void onPostTickEvent(PostTickEvent postTickEvent) {
        ...
        if(curEntity != null && curEntity.getDistanceToEntity(mc.thePlayer) > 6) {
            mc.thePlayer.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(curEntity.posX, curEntity.posY, curEntity.posZ, false));
        }
    ...
    public final void onPacket(PacketEvent packetEvent) {
        if(curEntity != null && curEntity.getDistanceToEntity(mc.thePlayer) > 6 && packetEvent.getPacket() instanceof C03PacketPlayer.C04PacketPlayerPosition) {
