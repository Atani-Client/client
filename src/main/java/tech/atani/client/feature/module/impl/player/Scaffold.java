...
@ModuleData(name = "Scaffold", description = "Bridging automatically", category = Category.PLAYER)
public class Scaffold extends Module {
    ...
    private final StringBoxValue towerMode = new StringBoxValue("Tower Mode", "How will the module tower?", this, new String[]{"Vanilla", "Verus", "NCP", "Matrix", "Intave", "Legit"}, new Supplier[]{() -> tower.getValue()});
    private final SliderValue<Long> unSneakDelay = new SliderValue<Long>("Unsneak delay", "What will be the delay between unsneaking?", this, 0L, 0L, 1000L, 0, new Supplier[]{() -> sneak.getValue() && sneakMode.is("Edge")});private final CheckBoxValue intaveBoost2 = new CheckBoxValue("Intave Speed Boost 2", "Add speed boost 2?", this, false);
    ...
    public final void onRotation(RotationEvent rotationEvent) {
        ...
        if (this.blockPos != null) {
            ...
            if(targetPitch + random >= 90)
                random = 0;
            rotations = RotationUtil.applyMouseFix(targetYaw, (float) (targetPitch + random));
    ...
    public void dragClick(double lengt, int minCps, int maxCps) {
