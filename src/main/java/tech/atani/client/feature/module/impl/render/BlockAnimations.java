...
public class BlockAnimations extends Module {
    ...
    public final StringBoxValue mode = new StringBoxValue("Style", "What animation should the sword use?", this, new String[]{"1.7", "Atani", "Atani 2", "Exhibition", "Flux", "Swang", "Swong", "Remix", "Spin", "Warped", "Push", "Slide"});
