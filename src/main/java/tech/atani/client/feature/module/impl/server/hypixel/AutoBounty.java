...
@ModuleData(name = "AutoBounty", identifier = "mc.hypixel.net AutoBounty", description = "Automatically lists all the people on the bounty", category = Category.SERVER, supportedIPs = {"mc.hypixel.net"})
