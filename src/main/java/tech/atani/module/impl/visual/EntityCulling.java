...
public class EntityCulling extends Module {
    ...
    public NumberValue cullingDelay = new NumberValue("Culling Delay", this, 2, 1, 3, 1);
    public ModeValue cullingMode = new ModeValue("Culling Mode", this, "Grouped", "Grouped", "Custom");
    public NumberValue entityCullingDis = new NumberValue("Culling Distance", this, 45, 10, 150, 1, () -> cullingMode.is("Grouped"));
    public NumberValue mobCullingDis = new NumberValue("Mob Cull Distance", this, 40, 10, 150, 1, () -> cullingMode.is("Custom"));
    public NumberValue playerCullingDis = new NumberValue("Player Cull Distance", this, 45, 10, 150, 1, () -> cullingMode.is("Custom"));
    public NumberValue passiveCullingDis = new NumberValue("Passive Cull Distance", this, 30, 10, 150, 1, () -> cullingMode.is("Custom"));
    ...
    @SubscribeEvent
    private final IEventListener<RendererLivingEntityEvent> onRenderer = e -> {
    ...
    @SubscribeEvent
    private final IEventListener<RenderTickEvent> onRenderTick = e -> {
