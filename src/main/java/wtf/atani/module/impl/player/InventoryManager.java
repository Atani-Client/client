...
public class InventoryManager extends Module {
    ...
    private final SliderValue<Long> minThrowDelay = new SliderValue<>("Minimum Throw Delay", "What will be the minimum delay between throwing each item?", this, 250L, 0L, 1000L, 0);
    private final SliderValue<Long> maxThrowDelay = new SliderValue<>("Maximum Throw Delay", "What will be the maximum delay between throwing each item?", this, 300L, 0L, 1000L, 0);
    ...
    private final CheckBoxValue keepTools = new CheckBoxValue("Keep Tools", "Keep tools such as pickaxes and axes?", this, true);
    private final SliderValue<Integer> weaponSlot = new SliderValue<>("Weapon Slot", "In which slot should the module put weapons?", this, 1, 0, 9, 0);
    private final SliderValue<Integer> bowSlot = new SliderValue<>("Bow Slot", "In which slot should the module put bows?", this, 2, 0, 9, 0);
    private final SliderValue<Integer> pickaxeSlot = new SliderValue<>("Pickaxe Slot", "In which slot should the module put pickaxes?", this, 0, 0, 9, 0);
    private final SliderValue<Integer> axeSlot = new SliderValue<>("Axe Slot", "In which slot should the module put axes?", this, 0, 0, 9, 0);
    private final SliderValue<Integer> shovelSlot = new SliderValue<>("Shovel Slot", "In which slot should the module put shovels?", this, 0, 0, 9, 0);
        ...
        for (int i = 9; i < 45; i++) {
            if (getPlayer().inventoryContainer.getSlot(i).getHasStack()) {
                ...
                if (throwTimer.hasReached((long) (throwDelay))) {
                    if (weaponSlot.getValue() != 0 && (is.getItem() instanceof ItemSword || is.getItem() instanceof ItemAxe || is.getItem() instanceof ItemPickaxe) && is == bestWeapon() && mc.thePlayer.inventoryContainer.getInventory().contains(bestWeapon()) && mc.thePlayer.inventoryContainer.getSlot((int) (35 + weaponSlot.getValue())).getStack() != is && !preferSwords.getValue()) {
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (weaponSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        }
                    } else if (weaponSlot.getValue() != 0 && is.getItem() instanceof ItemSword && is == bestSword() && mc.thePlayer.inventoryContainer.getInventory().contains(bestSword()) && mc.thePlayer.inventoryContainer.getSlot((int) (35 + weaponSlot.getValue())).getStack() != is && preferSwords.getValue()) {
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (weaponSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        ...
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (bowSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        }
                    } else if (pickaxeSlot.getValue() != 0 && is.getItem() instanceof ItemPickaxe && is == bestPick() && is != bestWeapon() && keepTools.getValue() && mc.thePlayer.inventoryContainer.getInventory().contains(bestPick()) && mc.thePlayer.inventoryContainer.getSlot((int) (35 + pickaxeSlot.getValue())).getStack() != is) {
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (pickaxeSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        }
                    } else if (axeSlot.getValue() != 0 && is.getItem() instanceof ItemAxe && is == bestAxe() && is != bestWeapon() && keepTools.getValue() && mc.thePlayer.inventoryContainer.getInventory().contains(bestAxe()) && mc.thePlayer.inventoryContainer.getSlot((int) (35 + axeSlot.getValue())).getStack() != is) {
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (axeSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        }
                    } else if (shovelSlot.getValue() != 0 && is.getItem() instanceof ItemSpade && is == bestShovel() && is != bestWeapon() && keepTools.getValue() && mc.thePlayer.inventoryContainer.getInventory().contains(bestShovel()) && mc.thePlayer.inventoryContainer.getSlot((int) (35 + shovelSlot.getValue())).getStack() != is) {
                        getPlayerController().windowClick(mc.thePlayer.inventoryContainer.windowId, i, (int) (shovelSlot.getValue() - 1), 2, mc.thePlayer);
                        throwTimer.reset();
                        if (throwDelay != 0) {
                            break;
                        }
