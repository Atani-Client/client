...
public class ServerButton extends MenuButton {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        normal.drawStringWithShadow(String.format("%s", serverData.serverName), posX + 10, posY + 2 + 1 + scroll, -1);
        ...
        {
            normal.drawString((String)list.get(i), posX + 10, posY + 15 + 1 + i * (normal.FONT_HEIGHT + 1) + scroll, 8421504);
        }
    }
