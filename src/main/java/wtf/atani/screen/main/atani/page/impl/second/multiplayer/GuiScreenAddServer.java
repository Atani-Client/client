package wtf.atani.screen.main.atani.page.impl.second.multiplayer;
...
{
    private final MultiPlayerPage parentScreen;
    ...
    public GuiScreenAddServer(MultiPlayerPage p_i1033_1_, ServerData p_i1033_2_)
    {
