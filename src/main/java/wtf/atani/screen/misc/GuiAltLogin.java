...
import wtf.atani.screen.elements.PasswordField;
import wtf.atani.screen.main.atani.page.impl.second.AccountPage;
...
extends GuiScreen {
    ...
    public GuiAltLogin(AccountPage accountPage) {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 1: {
                this.accountPage.confirmClicked(null, false, 0);
                break;
            }
            case 0: {
                this.accountPage.confirmClicked(new Account(username.getText(), password.getText(), password.getText() == null || password.getText() == ""), true, 1);
            }
        }
    }
