...
public class GradientShader implements Methods {
    ...
    private static final LegacyShader gradientMaskShader = new LegacyShader("atani/shaders/fragment/gradientMask.glsl");
    private static final LegacyShader gradientShader = new LegacyShader("atani/shaders/fragment/gradient.glsl");
    ...
    public static void drawGradient(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight) {
        ...
        LegacyShader.drawQuads(x, y, width, height);
